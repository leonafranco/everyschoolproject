...
<div class="container">
    <h1><?php echo CREATECOLLECTION ?></h1>
    <form id="form-register" action="../Include/register_new_collection.php" method="post" enctype="multipart/form-data">
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label"><?php echo COLLECTIONNAME ?></label>
