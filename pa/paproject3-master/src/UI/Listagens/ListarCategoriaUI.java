...
public class ListarCategoriaUI extends JFrame {
     ...
     */
    public ListarCategoriaUI(Main event, String lista) {
        ...
        mainJL = new JLabel("SKU   Designacao   Categoria");
        ...
        voltarBTN.setActionCommand("voltarListarCategoriaUI");
        ...
        pesquisaASCBTN.setActionCommand("ListarCategoriaUIAsc");
        ...
        pesquisaDESCBTN.setActionCommand("ListarCategoriaUIDesc");
