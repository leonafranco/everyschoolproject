...
/**
 * Metodo encomendaEntregueUI permite definir quando uma encomenda deve ser entregue
 */
public class EncomendaEntregueUI extends JFrame{
     ...
     * @param lista lista que esta mesmo será inserida dentro da jTextArea
     */
    public EncomendaEntregueUI(Main event, String lista) {
        ...
        aceitarButton = new JButton("Entregue");
        aceitarButton.setActionCommand("encomendaNovaEntregue");
    ...
    /**
     * Metodo que simplesmente retorna o que esta na textfield identificador
