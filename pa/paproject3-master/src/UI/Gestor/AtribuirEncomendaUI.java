...
/**
 * Classe que permite atribuir uma nova encomenda a um Armazenista
 */
public class AtribuirEncomendaUI extends JFrame {
     ...
     * @param identificador identificador das encomendas
     * @param lista lista de armazenistas para serem atribuidos tal enconemda
     */
    public AtribuirEncomendaUI(Main event, String identificador, String lista) {
        ...
        aceitarButton.setActionCommand("AtribuirEncomenda");
    ...
    /**
     * Informa qual a main qual o armazenista que deve ser notificado
     * @return o valor da skuJTF
     */
